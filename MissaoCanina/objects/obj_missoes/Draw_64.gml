...
if(global.missao==3){
	...
	draw_sprite_ext(spr_quadrado_preto,0,1000,80,8,2,0,c_black,0.5);
	draw_text_ext(1000,50,"Use (U) para achar os feridos nos escombros.",40,450);
	}
if(global.missao==4){
...
if(global.missao==5){
	...
	draw_sprite_ext(spr_quadrado_preto,0,1000,80,8,2,0,c_black,0.5);
	draw_text_ext(1000,50,"Fareje as minas do caminho leste \n e pegue os medicamentos no final do caminho.",40,450);
